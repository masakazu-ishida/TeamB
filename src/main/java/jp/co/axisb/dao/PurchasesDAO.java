...
public class PurchasesDAO extends BaseDAO {
	...
	public int insert(PurchasesDTO dto) throws SQLException {
		String sql = "insert into purchases(purchase_id, purchased_date, destination, cancel) values(?, ?, ?, ?)";
		int updateNum = 0;
	...
	public int update(PurchasesDTO dto) throws SQLException {
		String sql = "update purchases set purchase_id = ?, purchased_date = ?, destination = ?, cancel = ? where purchase_id = ?";
